...
<h4>Step 2: Gathering neighboring information</h4>
...
<h4>Result page and file download </h4>
...
<p>The default window for identifying neighbors is &plusmn; 10 orfs from the query sequence—the user can select a smaller/larger window on the Start page (from &plusmn;3 to &plusmn; 20 orfs).  As the size of the window decreases, the signal-to-noise in the GNN increases, although smaller windows may miss functionally linked neighbors.</p>
<p><img src='images/tutorial/generation_figure_1.jpg' width='600'></p>

<p>The 20 neighbors collected with the &plusmn; 10 orf default (or 2N neighbors collected with a user-specified &plusmn;N orf window) constitute the genome neighborhood for the query.  If a neighbor is an RNA (rRNA or tRNA), it is discarded although its "place" is included in the &plusmn; 10 orf count.  Each of the protein neighbors is then associated with a Pfam family using annotations provided by the UniProt and InterPro databases.</p>
